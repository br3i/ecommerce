  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="dist/img/logoEcommerce.png" alt="My Ecommerce Logo" class="brand-image img-circle elevation-3"
          style="opacity: 0.8" />
        <span class="brand-text font-weight-light">MY E-COMMERCE</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <div>
              <?php
              echo "<img src='data:image/png;base64," . base64_encode($_SESSION['fotoPerfil']) . "' class='img-circle elevation-2' alt='User Image' style='opacity: 0.9'>";
              ?>
            </div>
          </div>
          <div class="info">
